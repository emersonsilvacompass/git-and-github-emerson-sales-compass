...
| **Merge** | É a união(mesclar) de duas versões (branches) diferentes do código em uma só. |
| **Branch** | É uma linha do tempo paralela onde posso testar novas funcionalidades sem quebrar a versão principal. |
...
# Criar um registro com mensagem
git commit -m "feat: minha primeira documentação"

# Ver o histórico de forma resumida
git log --oneline

# Busca os dados do PR 
git fetch origin pull/ID/head:nome-da-branch-local